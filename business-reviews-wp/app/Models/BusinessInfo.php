...
class BusinessInfo {
	...
	public function paginationClass( $key ) {
		$class      = '';
		$pagination = ( isset( $_POST['pagination'] ) ) ? absint( $_POST['pagination'] ) : get_post_meta( $this->shortcode_id, 'pagination', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing

		$reviews_per_page = ( isset( $_POST['reviews_per_page'] ) ) ? absint( $_POST['reviews_per_page'] ) : get_post_meta( $this->shortcode_id, 'reviews_per_page', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing

		$review_display_limit = ( isset( $_POST['review_display_limit'] ) ) ? absint( $_POST['review_display_limit'] ) : get_post_meta( $this->shortcode_id, 'review_display_limit', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing
