...
class Review {
	...
	public function getDescription() {
		...
		$text_limit = ( isset( $_POST['review_text_limit'] ) ) ? absint( $_POST['review_text_limit'] ) : get_post_meta( $this->shortcode_id, 'review_text_limit', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing
		if ( $text_limit ) {
			$read_more_text = ( isset( $_POST['read_more_text'] ) ) ? sanitize_text_field( wp_unslash( $_POST['read_more_text'] ) ) : get_post_meta( $this->shortcode_id, 'read_more_text', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing

			$limit_type = ( isset( $_POST['review_text_limit_type'] ) ) ? sanitize_text_field( wp_unslash( $_POST['review_text_limit_type'] ) ) : get_post_meta( $this->shortcode_id, 'review_text_limit_type', true );  //phpcs:ignore WordPress.Security.NonceVerification.Missing
			if ( $limit_type == 'word' ) {
