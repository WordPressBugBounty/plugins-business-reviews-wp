...
$options = array(
	'fb_app_id'         => array(
		...
		'description' => wp_kses(
			__( 'If you want to use your own facebook app then you can mention the app id here. <a target="_blank" href="https://www.radiustheme.com/docs/business-reviews/configurations/facebook-settings/how-to-create-your-own-facebook-app-id">How to create app?</a>', 'business-reviews-wp' ),
			array(
				'a' => array(
					'href'   => true,
					'target' => true,
